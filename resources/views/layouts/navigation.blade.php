<nav x-data="{ open: true }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="h-28 w-auto" src="{{ asset('images/ADlogo.png') }}" alt="AD Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('user.userpalas')" :active="request()->routeIs('user.userpalas')">
                        {{ __('Palas') }}
                    </x-nav-link>

                    <x-nav-link :href="route('palas.misPalas')" :active="request()->routeIs('palas.misPalas')">
                        {{ __('Palas AD') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('pedidos.index')" :active="request()->routeIs('pedidos.index')" >
                        <img src="{{asset('images/mispedidos.png')}}" alt="Pedidos" class="h-8 w-8">
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('user.userpalas')" :active="request()->routeIs('user.userpalas')">
                {{ __('Palas') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('palas.misPalas')" :active="request()->routeIs('palas.misPalas')">
                {{ __('Palas AD') }}
            </x-responsive-nav-link>
            <!-- Carrito con imagen -->
